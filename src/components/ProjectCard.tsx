...
export function ProjectCard<T extends React.ElementType = 'div'>({
  as,
  className,
  children,
...
ProjectCard.Title = function ProjectCardTitle<T extends React.ElementType = 'h2'>({
  as,
  href,
  children,
...
ProjectCard.Cta = function ProjectCardCta({ children }: { children: React.ReactNode }) {
  return (
    <div
      aria-hidden="true"
...
ProjectCard.Eyebrow = function ProjectCardEyebrow<T extends React.ElementType = 'p'>({
  as,
  decorate = false,
  className,
  children,
